...
function Wave()
{
    ...
    var BUBBLE_FREQUENCY = 30; // Milliseconds between tweet bubbles being added to the wave
    ...
    this.Initialize = function (canvasID)
    {
        ...
        if (canvas && canvas.getContext)
        {
            ...
            tweetUpdateInterval = setInterval(CreateBubble, BUBBLE_FREQUENCY);
    ...
    function TimeUpdate(e)
    {
        ...
        gradientFill.addColorStop(0, '#F9CE7C');
        gradientFill.addColorStop(1, 'rgba(249,206,124,0)');
        ...
        context.fillStyle = "#rgba(249,206,124,0)";
        context.beginPath();
